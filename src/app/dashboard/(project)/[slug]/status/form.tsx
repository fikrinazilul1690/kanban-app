...
import { createStatus } from './action'
...
export function CreateStatusForm({ modal, project }: Props) {
  const router = useRouter()
  const [isClosed, setIsClosed] = useState(false)
  const containerRef = useRef<HTMLElement | null>(null)
  const createAction = createStatus.bind(
    null,
    project.slug,
    project.id,
    isClosed
  ...
  const [color, setColor] = useState('#A9AABC')
